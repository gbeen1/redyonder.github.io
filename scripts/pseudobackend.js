    ...
    static GetFilteredNCRs(applyFilters, ncrNo, poNo, suppName, sapNo, prodDesc, dateSort, hideActive, hideClosed){
        ...
        if(applyFilters === true){
            NCRs = NCRs.filter(function(ncr){
                ...
                if(hideClosed)
                    filterFits[6] = ncr.ncrActive != false;
                return filterFits[0] && filterFits[1] && filterFits[2] && filterFits[3] && filterFits[4] && filterFits[5] && filterFits[6];
            });
            if(dateSort == "new")
...
/*
class NCR{
    constructor(ID, POOrderNo, SalesOrderNo, SAPNo, DateOpened){
        this.ID = ID;
...
const ncrs = [
    new NCR(1, 3659782461, 8741523690, 1234567890, "10/06/2025"),
    new NCR(2, 4896275310, 2463897514, 9876543210, "09/30/2025"),
    new NCR(3, 5123478960, 8357649120, 1597534862, "02/23/2023"),
    new NCR(4, 6934892170, 1209485763, 7531598246, "05/15/2024"),
    new NCR(5, 7402518364, 5067892134, 3216549870, "07/31/2025"),
    new NCR(6, 8142573690, 3901456782, 4567891230, "01/02/2025"),
    new NCR(7, 9464812973, 5827391460, 9638527410, "12/09/2025"),
    new NCR(8, 1146752984, 6213857409, 1472583690, "09/20/2024"),
    new NCR(9, 2364985710, 8931245679, 2583691470, "04/28/2025"),
    new NCR(10, 3678459012, 7189654320, 3692581470, "05/01/2025"),
    new NCR(11, 4982143650, 1247835960, 7894561230, "03/06/2023"),
    new NCR(12, 5137826490, 9073421586, 1598527364, "07/08/2022"),
    new NCR(13, 6892154783, 3567528910, 9517538426, "11/25/2022"),
    new NCR(14, 7241596380, 4127893654, 7531594682, "11/18/2025"),
    new NCR(15, 8152764930, 5681237490, 8527419630, "05/17/2023"),
    new NCR(16, 9234675180, 6874312596, 6543217890, "12/03/2025"),
    new NCR(17, 1389462750, 7941360582, 1597536284, "12/29/2024"),
    new NCR(18, 2497658910, 8321504967, 4561237890, "08/26/2025"),
    new NCR(19, 3650471290, 6789451232, 9632587410, "09/09/2025"),
    new NCR(20, 4862197530, 1092475886, 1597584263, "04/08/2025")
];

function GetNCRByID(ID){
    let newNCR = new NCR(null, null, null, null);
...
function GetNewNCRNo(){
    return ncrs.length + 1;
}

function GetCurrentDate(){// taken from https://stackoverflow.com/questions/1531093/how-do-i-get-the-current-date-in-javascript
    let today = new Date();
...
class QAForm{
    constructor(ID, qaOptSupOrRecInsp, qaOptWIP, qaItemDesc, qaQuantityDefective, qaDefectDesc, qaNonConforming, qaEngNeeded, qaFinal){
        this.ID = ID;
        this.qaOptSupOrRecInsp = qaOptSupOrRecInsp;
        this.qaOptWIP = qaOptWIP;
        this.qaItemDesc = qaItemDesc;
        this.qaQuantityDefective = qaQuantityDefective;
        this.qaDefectDesc = qaDefectDesc;
        this.qaNonConforming = qaNonConforming;
        this.qaEngNeeded = qaEngNeeded;
        this.qaFinal = qaFinal;
    }
}

const qaforms = [
    new QAForm(1, null, null, null, null, null, null, null, false),
    new QAForm(2, true, false, null, 15, "Bent so as to be unusable", true, false, true),
    new QAForm(3, null, null, null, null, null, null, null, false),
    new QAForm(4, false, true, null, 23, "Missing components", true, false, true),
    new QAForm(5, true, false, null, 15, "Unable to accurately describe", false, true, true),
    new QAForm(6, false, true, null, 36, "Plastic components cracked", true, false, true),
    new QAForm(7, false, true, null, 23, "Faulty printing", true, false, true),
    new QAForm(8, false, true, null, 43, "Bent pipes", true, true, true),
    new QAForm(9, true, false, null, 1, "Holes in shell", true, true, true),
    new QAForm(10, null, null, null, null, null, null, null, false),
    new QAForm(11, true, true, null, 20, null, null, null, true),
    new QAForm(12, false, true, null, 11, null, null, null, true),
    new QAForm(13, false, true, null, 13, null, null, null, true),
    new QAForm(14, null, null, null, null, null, null, null, false),
    new QAForm(15, true, false, null, 12, null, null, null, true),
    new QAForm(16, false, true, null, 5, null, null, null, true),
    new QAForm(17, true, false, null, 9, null, null, null, true),
    new QAForm(18, true, false, null, 35, null, null, null, true),
    new QAForm(19, true, false, null, 90, null, null, null, true),
    new QAForm(20, true, false, null, 10, null, null, null, true)
];

function GetQAFormList(){
    return qaforms;
}

function GetQAFormById(ID){
    let newQA = new QAForm(null, null, null, null, null, null, null, null, null)
    qaforms.forEach(function(qaform){
        if(qaform.ID == ID)
            newQA = qaform;
    });
    return newQA;
...
const suppliers = [
    new Supplier(1, "Global Tech Supplies"),// supplier info generated by duckai/gpt mini
    new Supplier(2, "Eco Innovations Ltd."),
    new Supplier(3, "Reliable Manufacturing Co."),
    new Supplier(4, "Precision Parts Inc."),
    new Supplier(5, "Sustainable Materials Group"),
    new Supplier(6, "Vertex Solutions LLC"),
    new Supplier(7, "Quality Tools & Supplies"),
    new Supplier(8, "Smart Energy Providers"),
    new Supplier(9, "Future Concepts Trading"),
    new Supplier(10, "Advanced Logistics Corp."),
    new Supplier(11, "Artisan Craftworks Co."),
    new Supplier(12, "NextGen Hardware Co."),
    new Supplier(13, "Innovation Station Supplies"),
    new Supplier(14, "Proven Energy Solutions"),
    new Supplier(15, "Universal Supply Network"),
    new Supplier(16, "Dynamic Resource Group"),
    new Supplier(17, "Optimized Supply Chain"),
    new Supplier(18, "Impactful Products Inc."),
    new Supplier(19, "Visionary Supply Solutions"),
    new Supplier(20, "Pinnacle Resources Limited")
]
...
function GetSupplierByID(ID){
    newSupplier = new Supplier(null, null)
...
class Product{
    constructor(ID, productDescription, supplierID){
        this.ID = ID;
...
const products = [
    new Product(1234567890, "Wireless Charger", 15), // also generated with duckai/gpt mini
    new Product(9876543210, "Bluetooth Speaker", 8), 
    new Product(1597534862, "Smart Light Bulb", 12), 
    new Product(7531598246, "Ergonomic Keyboard", 5), 
    new Product(3216549870, "Fitness Tracker", 18), 
    new Product(4567891230, "Portable SSD", 4), 
    new Product(9638527410, "4K TV", 10), 
    new Product(1472583690, "Noise-Canceling Headphones", 19), 
    new Product(2583691470, "Digital Camera", 3), 
    new Product(3692581470, "Smart Thermostat", 11), 
    new Product(7894561230, "Water Bottle", 6), 
    new Product(1598527364, "Air Purifier", 20), 
    new Product(9517538426, "Gaming Mouse", 14), 
    new Product(7531594682, "Camping Tent", 2), 
    new Product(8527419630, "LED Desk Lamp", 9), 
    new Product(6543217890, "Fitness Gym Bag", 17), 
    new Product(1597536284, "Smartwatch", 1), 
    new Product(4561237890, "Television Stand", 16), 
    new Product(9632587410, "Coffee Maker", 8), 
    new Product(1597584263, "Multi-Cooker", 13), 
    new Product(8523691470, "USB Hub", 5), 
    new Product(3217896540, "Wireless Earbuds", 12), 
    new Product(1478523690, "Digital Scale", 3), 
    new Product(2581479630, "Portable Fan", 20), 
    new Product(3697412580, "Outdoor Grill", 18), 
    new Product(9512587531, "Phone Stand", 7), 
    new Product(7538241590, "Vacuum Cleaner", 15), 
    new Product(1594561237, "Router", 9), 
    new Product(7531594863, "E-Reader", 4), 
    new Product(8524631590, "Pressure Cooker", 11), 
    new Product(7412589630, "Rice Cooker", 2), 
    new Product(9638527411, "Meal Prep Containers", 6), 
    new Product(7896541231, "Electric Kettle", 19), 
    new Product(1597538520, "Luggage Set", 1), 
    new Product(2583697410, "Fitness Resistance Bands", 14), 
    new Product(3692581471, "Bicycle Pump", 16), 
    new Product(1472589631, "Travel Backpack", 10), 
    new Product(6543219870, "Laptop Sleeve", 8), 
    new Product(3214569870, "LED Strip Lights", 12), 
    new Product(7893216540, "Pet Feeder", 17), 
    new Product(9518529630, "Yoga Mat", 3)
];
...
function GetProductByID(ID){
    newProduct = new Product(null, null, null);
